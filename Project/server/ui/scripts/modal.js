document.addEventListener('DOMContentLoaded', function () {
    ...
    var acknowledgementModal = document.getElementById("acknowledgementModal");
    // Acknowledgement Button
    var acknowledgementButton = document.getElementById("acknowledgementButton");
    ...
    // Open modal for Acknowledgement
    acknowledgementButton.onclick = function () {
        acknowledgementModal.style.display = "block";
    };
    ...
    for (var i = 0; i < closeButtons.length; i++) {
        closeButtons[i].onclick = function () {
            ...
            acknowledgementModal.style.display = "none";
        };
    }
    ...
    window.onclick = function (event) {
        if (event.target == locationModal) {
            ...
            sectorModal.style.display = "none";
        } if (event.target == NRModal) {
            NRModal.style.display = "none";
        } if (event.target == RFModal) {
            RFModal.style.display = "none";
        } if (event.target == FMModal) {
            FMModal.style.display = "none";
        } if (event.target == acknowledgementModal) {
            acknowledgementModal.style.display = "none";
        }
    }
});